/*Beginning with an empty binary search tree, Construct binary search tree by inserting the
 values in the order given. After constructing a binary tree - done
 i. Insert new node done
 ii. Find number of nodes in longest path from root
 iii. Minimum data value found in the tree not done
 iv. Change a tree so that the roles of the left and right pointers are swapped at every
 node
 v. Search a value done
 */
